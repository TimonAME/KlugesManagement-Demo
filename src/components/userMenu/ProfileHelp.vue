...
const categories = [
  { name: 'Nutzungsbedingungen und Richtlinien', url: '/dashboard' },
  { name: 'Hilfe', url: '/tipps' },
  { name: 'Feedback senden', url: '/dashboard' },
]
...
<template>
  <div class="relative dropdown-container">
    ...
    >
      ...
      <div class="flex flex-row gap-4 items-center">
        <svg
          ...
          class="stroke-icon_color hover:stroke-main transition-colors duration-100"
          width="24"
          height="24"
          viewBox="0 0 24 24"
          fill="none"
    ...
    <div
      v-if="showDropdown"
      class="z-20 absolute top-full sm:right-0 right-[-64px] mt-0 w-80 bg-window_bg rounded-[1.3rem] sm:rounded-tr-none rounded-tr-[1.3rem] shadow-window"
    >
      <ul>
        <li
          ...
          class="cursor-pointer px-4 py-2 hover:bg-first_accent hover:text-white rounded-3xl transition-colors duration-100"
        >
