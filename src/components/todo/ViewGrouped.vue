...
<template>
  <div v-for="group in groupedTodos" :key="group.dueDate" class="mb-10">
        ...
        <div class="flex items-center gap-4 group/item">
          ...
          >
            ...
            <path
              :class="
                activeView === 'erledigt'
                  ? 'block'
                  : 'stroke-icon-color hidden group-hover/svg:block'
              "
          ...
          <div class="flex-1">
            ...
            <div class="flex flex-row items-center gap-4">
              <p
                v-if="todo.dueDate"
                class="text-sm text-secondary_text flex flex-row gap-1 items-center"
              >
                <svg
                  v-if="formatDueTime(todo.dueDate.date) !== null"
    ...
    <!-- Add Task Form -->
    <div>
      <div class="p-4 cursor-pointer" @click="openTaskForm(group.dueDate)">
